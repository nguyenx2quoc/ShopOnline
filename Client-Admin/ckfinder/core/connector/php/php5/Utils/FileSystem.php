...
class CKFinder_Connector_Utils_FileSystem
{
  ...
  'û' => 'u', 'þ' => 'th', 'ð' => 'dh', 'æ' => 'ae', 'µ' => 'u', 'ĕ' => 'e','û' => 'u',
   'þ' => 'th', 'ð' => 'dh', 'æ' => 'ae', 'µ' => 'u', 'ĕ' => 'e', ' ' => '-',
   'á'=> "a" ,'ạ'=> "a" ,'ả'=> "a" ,'ã'=> "a" ,'â'=> "a" ,'ầ'=> "a" ,'ấ'=> "a" ,'ậ'=> "a" ,
   'ẩ'=> "a" ,'ẫ'=> "a" ,'ă'=> "a" ,'ằ'=> "a" ,'ắ'=> "a" ,'ặ'=> "a" ,'ẳ'=> "a" ,'ẵ' => "a",
   'è'=> "e",'ẹ'=> "e",'ẻ'=> "e",'ẽ'=> "e",'ê'=> "e",'ề'=> "e",'ế'=> "e",'ệ'=> "e",'ể'=> "e",'ễ' => "e",
   'ị'=> "i",'ỉ'=> "i",'ó'=> "o",'ọ'=> "o",'ỏ'=> "o",'õ'=> "o",'ồ'=> "o",'ố'=> "o",'ộ'=> "o",'ổ'=> "o",'ỗ'=> "o",
    'ờ'=> "o",'ớ'=> "o",'ợ'=> "o",'ở'=> "o",'ỡ' => "o",
  ...
  'À' => 'A', 'Ô' => 'O', 'Ộ'=>'O', 'Ď' => 'D', 'Ḟ' => 'F', 'Ë' => 'E', 'Š' => 'S', 'Ơ' => 'O',
  ...
  'Û' => 'U', 'Þ' => 'Th', 'Ð' => 'Dh', 'Æ' => 'Ae', 'Ĕ' => 'E',
   ...
   'Ẩ'=> "A" ,'Ẫ'=> "A" ,'Ă'=> "A" ,'Ằ'=> "A" ,'Ắ'=> "A" ,'Ặ'=> "A" ,'Ẳ'=> "A" ,'Ẵ' => "A",
   'È'=> "E",'Ẹ'=> "E",'Ẻ'=> "E",'Ẽ'> "E",'Ê'=> "E",'Ề'=> "E",'Ế'=> "E",'Ệ'=> "E",'Ể'=> "E",'Ễ' => "E",
   'Ị'=> "I",'Ỉ'=> "I",'Ĩ' => "I",'Ó'=> "O",'Ọ'=> "O",'Ỏ'=> "O",'Õ'=> "O",'Ồ'=> "O",'Ố'=> "O",'Ộ'=> "O",'Ổ'=> "O",'Ỗ'=> "O",
    'Ờ'=> "O",'Ớ'=> "O",'Ợ'=> "O",'Ở'=> "O",'Ỡ' => "O",
    'Ù' => "U",'Ú' => "U",'Ụ' => "U",'Ủ' => "U",'Ũ' => "U",'Ư' => "U",'Ừ' => "U",'Ứ' => "U",
    'Ự' => "U",'Ử' => "U",'Ữ' => "U",
    'Ỳ'=> "Ỳ",'Ỵ'=> "Y",'Ỷ'=> "Y",'Ỷ' => "Y",
